...
public class RecipeDaoImpl implements RecipeDao {
    ...
    private static final String GET_RECIPES_BY_TYPE_SQL = "SELECT RECIPE_ID, NAME, INGREDIENTS, DIRECTIONS, DESCR " +
            "FROM RECIPE R INNER JOIN RECIPE_TYPE RT ON R.RECIPE_TYPE_ID = RT.RECIPE_TYPE_ID" +
            "WHERE RECIPE_TYPE_ID = ?";
    private static final String GET_RECIPE_BY_NAME_SQL = "SELECT RECIPE_ID, NAME, INGREDIENTS, DIRECTIONS, DESCR " +
            "FROM RECIPE R INNER JOIN RECIPE_TYPE RT ON R.RECIPE_TYPE_ID = RT.RECIPE_TYPE_ID" +
            "WHERE NAME = ?";
